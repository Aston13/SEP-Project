 ...
 * any particular Controller (<i>i.e.</i>, a View should be inter operable with
 ...
 * or some combination thereof. The design can depend on whether the UI supports
 * synchronous or asynchronous user interactions.
 *
...
public abstract class AbstractView {
     ...
     * {@link #run()}.
     * <p>
     * May be called by the top-level application boot strapper (<i>e.g.</i>,
    ...
    /**
     * Get the model bound to the registered Controller, if a Controller has
     * been registered.
     *
